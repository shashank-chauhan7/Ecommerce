    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .version("1.0.0")
                .description("Full-text product search powered by Elasticsearch with Redis-cached results. Supports multi-field queries across product name, description, and brand with fuzzy matching.")
